export const advanced = [
    {
        ...
        desc:
        {
            ...
            icon_alt: '배민1 아이콘',
            body: [
                { item: '배민1(배민원)은 일반 배달보다 빠른 배달입니다.' },
                { item: '일반 배달은 여러 집을 다니기 때문에 시간이 오래 걸립니다.' },
                { item: '하지만 배민1은 한 집만 빠르게 배달합니다.' },
                { item: '빠르게 음식을 먹고 싶을 때 배민1을 사용해보세요.' },
            ]
        },
        tips:
        {
            title: '이럴 때 사용해봐요!',
            body: [
                { item: '친구들이 놀러왔는데 음식이 없어서 빨리 배달을 시켜야 할 때' },
                { item: '배가 너무 고파서 빨리 오는 음식을 먹고 싶을 때' },
                { item: '방금 만든 음식을 가장 맛있는 상태로 먹고 싶을 때' },
            ]
        },
    ...
    },
    {
        ...
        desc:
        {
            ...
            icon_alt: '',
            body: [
                { item: '배달팁 낮은 순은 배달팁이 싼 순서대로 검색 결과를 볼 수 있는 기능입니다.' },
                { item: '배달팁이 무료인 곳부터 볼 수 있습니다.' },
            ]
        },
        tips:
        {
    ...
    },
    {
        ...
        desc:
        {
            ...
            icon_alt: '포장 아이콘',
            body: [
                { item: '포장은 주문한 음식을 직접 가지러 가는 것입니다.' },
                { item: '집 근처 포장할 수 있는 가게를 찾을 수 있습니다.' },
            ]
        },
        tips:
        {
            title: '이럴 때 사용해봐요!',
            body: [
                { item: '집 근처의 포장할 수 있는 가게가 궁금할 때' },
                { item: '외출했다가 돌아오는 길에 음식을 포장하고 싶을 때' },
            ]
        },
    ...
    },
    {
        ...
        desc:
        {
            ...
            icon_alt: '1인분 아이콘',
            body: [
                { item: '1인분의 음식을 주문할 수 있는 기능입니다.' },
                { item: '최소주문금액이 적어서 음식 1개만 시켜도 배달해줍니다.' },
                { item: '1인분만 먹고 싶을 때 사용해보세요.' },
            ]
        },
        tips:
        {
            title: '이럴 때 사용해봐요!',
            body: [
                { item: '혼자서 배달음식을 시켜먹어야 할 때' },
                { item: '시켜먹는 음식의 양이 너무 많을 때' },
                { item: '1인분, 한 그릇의 음식을 먹고 싶을 때' },
            ]
        },
    ...
    },
    {
        ...
        desc:
        {
            ...
            icon_alt : '',
            body: [
                { item: '주문 내역을 보면 예전에 시켰던 곳을 확인할 수 있습니다.' },
                { item: '언제 어떤 가게에서 어떤 음식을 시켰는지 볼 수 있습니다.' },
                { item: '주문 내역을 보고 똑같은 메뉴를 시킬 수도 있고, 가게나 음식의 리뷰를 쓸 수도 있습니다.' },
            ]
        },
        tips:
        {
            title: '이럴 때 사용해봐요!',
            body: [
                { item: '예전에 먹었던 음식이 맛있어서 또 주문하고 싶을 때' },
                { item: '주문했던 가게의 정보, 음식 가격을 알고 싶을 때' },
                { item: '주문했던 음식의 리뷰를 쓰고 싶을 때' },
            ]
        },
    ...
    },
    {
        ...
        desc:
        {
            ...
            icon_alt: '',
            body: [
                { item: '가게 사장님께 메시지를 보내서 원하는 것을 말하면 사장님이 메시지를 보고 부탁을 들어줍니다.' },
                { item: '필요한 것이 있다면 주문하기 전에 가게 사장님께 부탁해보세요.' },
                { item: '*들어주기 어려운 부탁은 사장님이 들어주지 못할 수도 있습니다.' },
            ]
        },
        tips:
        {
            title: '이럴 때 사용해봐요!',
            body: [
                { item: '알레르기가 있는 재료를 빼달라고 할 때' },
                { item: '싫어하는 재료를 빼달라고 할 때' },
                { item: '가게 사장님에게 부탁하고 싶은 것이 있을 때' },
        ...
        content: [
            ...
            },
            {
                ...
                desc: `아래로 내리면 ‘가게 사장님께’가 있다.<br className="only-mobile"> 회색 빈칸에 원하는 것을 적고 결제한다.`,
                alt: '배달의민족 텍스트를 입력하고 검색버튼을 누르는 이미지',
            },
        ]
    ...
    },
    {
        ...
        desc:
        {
            ...
            icon_alt: 'B마트 아이콘',
            body: [
                { item: 'B마트(비마트)는 생활에 필요한 물건 배달입니다.' },
                { item: '음식 재료, 세제, 화장지 등 급하게 필요한 물건을 주문하고 배달 음식처럼 빠르게 받을 수 있습니다.' },
            ]
        },
        tips:
        {
            title: '이럴 때 사용해봐요!',
            body: [
                { item: '요리에 필요한 재료를 빠르게 배달 받고 싶을 때' },
                { item: '세제, 화장지 등 생활용품이 급하게 필요할 때' },
                { item: '과자, 음료수, 컵라면도 배달시켜 먹고 싶을 때' },
            ]
        },
    ...
    },
    {
        ...
        desc:
        {
            ...
            icon: '',
            body: [
                { item: '쿠폰이 있으면 주문할 때 할인받을 수 있습니다.' },
                { item: '쿠폰을 주는 가게를 확인하고 주문해보세요.' },
                { item: '쿠폰을 사용하면 음식을 더 싸게 먹을 수 있답니다.' },
            ]
        },
        tips:
        {
            ...
            body:
                [
                    { item: '돈을 아끼고 싶을 때' },
                    { item: '딱히 먹고 싶은 음식은 없고 싸게 먹고 싶을 때' },
                ]
        },
